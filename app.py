...
<style>
    ...
    .info-box { background:#f0f4ff; border-left:4px solid #667eea; padding:0.8rem 1rem; border-radius:6px; margin:0.5rem 0; color:#ffffff !important; font-size:1rem; }
...
st.markdown('<div class="sub-title">Physics-Informed Neural Network for Bone Health and Osteoporosis Risk Prediction</div>', unsafe_allow_html=True)
...
<div class="{tcat_cards[tcat]}" style="margin:1rem 0; padding:1.2rem;">
    <div style="font-size:2rem;">{tcat_names[tcat]}</div>
...
ts_x    = ts_norm * 6
ax2.scatter([ts_x], [0], color='white', s=250, zorder=10, marker='v', label=f"Your T-score: {result['tscore']}")
...
st.markdown("---")
st.markdown("""
<div style='text-align:center; color:#ffffff; font-size:0.8rem;'>
